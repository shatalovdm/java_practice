...
public class AvgRates_HashMapTest {
    ...
    public void testReadData() {
        ...
        //Assert.assertEquals("{id_14=3.875, id_7=3.75, id_99=5.0, id_254=4.5, id_165=3.75, id_145=4.5, id_1=3.8333333333333335, id_15=4.333333333333333, id_16=3.0}", new AvgRates_HashMap().addRate(rates, "id_99", 3).toString());
    }
}
